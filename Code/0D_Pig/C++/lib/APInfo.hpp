...
void APInfor::ReportLastTwoPig() {
	...
	std::cout 
	<< "APD95"   << std::setw(n_width)
	<< "APD50"   << std::setw(n_width)
	<< "Vmax"   << std::setw(n_width)
	<< "Vmin"  << std::setw(n_width)
	<< "dVdtmax"  << std::setw(n_width)
	<< "-dVdtmax"  << std::setw(n_width)
	<< "plat_avg"  << std::setw(n_width)
	<< "plat50" << std::setw(n_width)
	<< "plat75" << std::setw(n_width)
	<< "INa_max"
	// << "CaT_max"  << std::setw(n_width)
	// << "CaT_min"  << std::setw(n_width)
	// << "CaD_Tau"  << std::setw(n_width)
	// << "CaD_peak_T"  
	...
	for(int i = 0; i < 2; i++){
		std::cout 
			<< APD_out_end[i] << std::setw(n_width)
			<< APD50_out[i] << std::setw(n_width)
			<< Vmax_out[i] << std::setw(n_width)
			<< Vmin_out[i] << std::setw(n_width)
			<< dVdtmax_out[i] << std::setw(n_width)
			<< neg_dVdtmax_out[i] << std::setw(n_width)
			<< plateau_potential_out[i] << std::setw(n_width)
			<< plateau50_out[i] << std::setw(n_width)
			<< plateau75_out[i] << std::setw(n_width)
			<< INa_max_out[i] 
			// << CaT_max_out[i] << std::setw(n_width)
			// << CaT_min_out[i] << std::setw(n_width)
			// << CaD_Tau_out[i]     << std::setw(n_width)
			// << CaD_peak_T_out[i]  
			<< std::endl;
	}
}
