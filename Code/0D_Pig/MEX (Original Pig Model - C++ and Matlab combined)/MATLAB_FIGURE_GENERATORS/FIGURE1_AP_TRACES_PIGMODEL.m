...
for cell_type =1:3
    if cell_type == 1
        ...
        ap_data = load("../outputs/results/control_results_1000.txt");
        cell_name = "Control";
    elseif cell_type == 2
        load('./FIGURE1_DATA/r_ions_data.mat')
        data_ions_tmp = r_ions_data;
        ap_data = load("../outputs/results/remote_results_1000.txt");
        cell_name = "Remote";
    elseif cell_type == 3
        load('./FIGURE1_DATA/b_ions_data.mat')
        data_ions_tmp = b_ions_data;
        ap_data = load("../outputs/results/border_results_1000.txt");
        cell_name = "Border";
    else
    ...
    xlabel("t (ms)",'FontSize', 100, 'fontweight', 'normal');
    ylabel("V (mV)",'FontSize', 100, 'fontweight', 'normal');
    ...
    output_root = './FIGURE1_DATA/SVGs_FIGURE1/';
