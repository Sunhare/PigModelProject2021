...
function Total_Error = PIG_COST_FUNCTION(parameters, OPTIMIZATION_SWITCH, thread_ID, EAD_VALUES)
    ...
    results_file = PIG_MEX(parameters, thread_ID, EAD_VALUES); %Run the simulation
