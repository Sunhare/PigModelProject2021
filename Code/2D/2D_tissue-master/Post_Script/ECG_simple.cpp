...
#define NX 301//203//;(462)
#define NY 301//203//;(325)
#define NZ 1//3//;(358)
...
#define DD (D1-D2)
#define dx 0.30  // change the spatial step accordingly. haibo
...
int main(int argc, char const *argv[])
{
	...
	std::string filename = "../Geometry/TWO_D_Plat_301X301X1.geo.gz";//TWO_D_Plat_301X301X1.geo.gz";// "Geometry/Vent_seeman_Add_RV_Stim_RG.mat.gz";
	...
	std::string output_name = to_string_with_precision(x_loc) + "_" + to_string_with_precision(y_loc) + "_" + to_string_with_precision(z_loc) + "_" + ".dat";
	std::ofstream ecg_out (output_name.c_str(), std::ofstream::out | std::ofstream::app);
	...
	for (int i = start; i <= end; i++ ) {
		...
		std::string potential_filename = foldername + "/v" + std::string(int_string) + ".bin";
